...
export const getPieCharts = asyncMiddleware(async (req, res, next) => {
    ...
    if (myCache.has(key)) {
        ...
        const [processingOrder, shippedOrder, deliveredOrder, categories, productsCount, productsOutOfStock, allOrder, allUsers, adminUsers, customerUsers,] = await Promise.all([
